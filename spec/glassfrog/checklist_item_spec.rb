...
describe Glassfrog::ChecklistItem do
  ...
  describe '#get' do
    ...
    it 'should return an array of checklist item objects with singular symbol as type' do
      array_of_checklist_items = @client.get :checklist_items
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should return an array of checklist item objects with plural symbol as type' do
      array_of_checklist_items = @client.get :checklist_items
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should return an array of checklist item objects with singular string as type' do
      array_of_checklist_items = @client.get 'checklist item'
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should return an array of checklist item objects with plural string as type' do
      array_of_checklist_items = @client.get 'checklist items'
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end

    it 'should return an array of checklist item objects with string as options' do
      array_of_checklist_items = @client.get :checklist_items, "#{@checklist_item.id}"
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should return an array of checklist item objects with integer as options' do
      array_of_checklist_items = @client.get :checklist_items, @checklist_item.id
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end

    it 'should return an array of checklist item objects with id in hash as options' do
      array_of_checklist_items = @client.get :checklist_items, { id: @checklist_item.id }
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should return an array of checklist item objects with checklist item object as options' do
      array_of_checklist_items = @client.get :checklist_items, @checklist_item
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end

    it 'should return an array of checklist item objects with circle object as options' do
      array_of_checklist_items = @client.get :checklist_items, @circle
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should return an array of checklist item objects with circle_id in hash as options' do
      array_of_checklist_items = @client.get :checklist_items, { circle_id: @circle.id }
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end

    it 'should return an array of all circle objects with no options' do
      array_of_checklist_items = @client.get :checklist_items
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
  ...
  describe '#post' do
    ...
    it 'should create a new checklist item object on GlassFrog with hash as options and returns this new object' do
      array_of_checklist_items = @client.post :checklist_items, @new_checklist_item_hash
      expect(array_of_checklist_items).to all(be_a(Glassfrog::ChecklistItem))
    end
    it 'should create a new checklist item object on GlassFrog with a checklist item object as options and returns this new object' do
  ...
  describe '#patch' do
    ...
    it 'should update a checklist item object on GlassFrog with a checklist item object as options without identifier' do
    ...
    it 'should update a checklist item object on GlassFrog with a hash as options without identifier' do
    ...
    it 'should update a checklist item object on GlassFrog with a checklist item object as options with identifier' do
      id = @checklist_item.id
      options = @client.patch :checklist_item, id, @checklist_item
      expect(options).not_to be(false)
      expect(@client.get(:checklist_item, options).first.description).to eq(@checklist_item.description)
    end
    it 'should update a checklist item object on GlassFrog with a hash as options with identifier' do
